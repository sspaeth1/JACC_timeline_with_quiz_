var TL = (function (t) {
    ...
    t.exports = (function () {
      ...
      return (function t() {
        ...
        var pt = R,
          ...
          Vt = function (t) {
            (Gt && Gt === t) ||
              ((t && "object" === (void 0 === t ? "undefined" : W(t))) || (t = {}),
              (t = T(t)),
              (bt = "ALLOWED_TAGS" in t ? k({}, t.ALLOWED_TAGS) : xt),
              (kt = "ALLOWED_ATTR" in t ? k({}, t.ALLOWED_ATTR) : Tt),
              (Ut = "ADD_URI_SAFE_ATTR" in t ? k(T(Zt), t.ADD_URI_SAFE_ATTR) : Zt),
              (Bt = "ADD_DATA_URI_TAGS" in t ? k(T(Wt), t.ADD_DATA_URI_TAGS) : Wt),
        ...
        var te = "http://www.w3.org/1998/Math/MathML",
          ...
          ne = function (t) {
            ...
            if (t.namespaceURI === ee)
              return e.namespaceURI === ie ? "svg" === i : e.namespaceURI === te ? "svg" === i && ("annotation-xml" === n || Jt[n]) : Boolean(Kt[i]);
          ...
          he = function (t) {
            return "object" === (void 0 === l ? "undefined" : W(l))
              ? t instanceof l
              : t && "object" === (void 0 === t ? "undefined" : W(t)) && "number" == typeof t.nodeType && "string" == typeof t.nodeName;
          },
          ce = function (t, e, n) {
            ft[t] &&
              d(ft[t], function (t) {
          ...
          ue = function (t) {
            ...
            if (!bt[n] || Mt[n]) {
              if (qt && !$t[n]) {
                var r = it(t),
                  a = et(t);
                if (a && r) for (var o = a.length - 1; o >= 0; --o) r.insertBefore(Q(a[o], !0), tt(t));
              }
              return re(t), !0;
            }
            return t instanceof h && !ne(t)
              ? (re(t), !0)
              : ("noscript" !== n && "noembed" !== n) || !w(/<\/no(script|embed)/i, t.innerHTML)
              ? (At &&
                  3 === t.nodeType &&
                  ((e = t.textContent),
                  (e = g(e, pt, " ")),
                  (e = g(e, _t, " ")),
                  t.textContent !== e && (p(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
          ...
          fe = function (t) {
            ...
            var o = t.attributes;
            if (o) {
              var s = { attrName: "", attrValue: "", keepAttr: !0, allowedAttributes: kt };
              for (a = o.length; a--; ) {
                var l = (e = o[a]),
                  h = l.name,
                  c = l.namespaceURI;
          ...
          pe = function t(e) {
            ...
            for (ce("beforeSanitizeShadowDOM", e, null); (i = n.nextNode()); )
              ce("uponSanitizeShadowNode", i, null), ue(i) || (i.content instanceof o && t(i.content), fe(i));
        ...
        return (
          (i.sanitize = function (t, r) {
            ...
            if ((Ct || Vt(r), (i.removed = []), "string" == typeof t && (Ft = !1), Ft));
              ...
              (1 === (s = (a = oe("\x3c!----\x3e")).ownerDocument.importNode(t, !0)).nodeType && "BODY" === s.nodeName) || "HTML" === s.nodeName
                ? (a = s)
                : a.appendChild(s);
            else {
            ...
            for (var d = se(Ft ? t : a); (h = d.nextNode()); )
              (3 === h.nodeType && h === c) || ue(h) || (h.content instanceof o && pe(h.content), fe(h), (c = h));
            if (((c = null), Ft)) return t;
            if (It) {
              if (Ot) for (u = ct.call(a.ownerDocument); a.firstChild; ) u.appendChild(a.firstChild);
              else u = a;
    ...
    (function (t, n) {
       ...
       */ (function () {
        var a = "Expected a function",
          ...
          Ot = RegExp(
            [
              Mt + "?" + yt + "+(?:['’](?:d|ll|m|re|s|t|ve))?(?=" + [_t, Mt, "$"].join("|") + ")",
              Lt + "+(?:['’](?:D|LL|M|RE|S|T|VE))?(?=" + [_t, Mt + Et, "$"].join("|") + ")",
          ...
          qt = -1,
          Ft = {};
        (Ft[M] = Ft[E] = Ft[L] = Ft[S] = Ft[D] = Ft[A] = Ft["[object Uint8ClampedArray]"] = Ft[j] = Ft[C] = !0),
          (Ft[l] = Ft[h] = Ft[k] = Ft[c] = Ft[T] = Ft[u] = Ft[d] = Ft[f] = Ft[_] = Ft[m] = Ft[g] = Ft[v] = Ft[y] = Ft[w] = Ft[x] = !1);
        var Ht = {};
        (Ht[l] =
          Ht[h] =
          Ht[k] =
        ...
        var Je = (function t(e) {
          var i,
            n = (e = null == e ? Gt : Je.defaults(Gt.Object(), e, Je.pick(Gt, Pt))).Array,
            r = e.Date,
            V = e.Error,
            dt = e.Function,
            ft = e.Math,
            ...
            for (var h in t)
              (!e && !kt.call(t, h)) ||
                (o &&
                  ("length" == h ||
                    (r && ("offset" == h || "parent" == h)) ||
                    (a && ("buffer" == h || "byteLength" == h || "byteOffset" == h)) ||
                    sa(h, l))) ||
                s.push(h);
            return s;
          }
          ...
          function Gi(t, e, i) {
            "__proto__" == e && ve ? ve(t, e, { configurable: !0, enumerable: !0, value: i, writable: !0 }) : (t[e] = i);
          }
          function Yi(t, e) {
          ...
          (Si.templateSettings = { escape: F, evaluate: H, interpolate: $, variable: "", imports: { _: Si } }),
            ...
            (Oi.prototype.clear = function () {
              (this.size = 0), (this.__data__ = { hash: new Ni(), map: new (fi || Ii)(), string: new Ni() });
            }),
                        ...
                        (c = l),
                          d || f || p
                            ? Io(s)
                              ...
                              : (c = [])
                            : Yo(l) || No(l)
                            ? ((c = s), No(s) ? (c = ss(s)) : (Wo(s) && !Ho(s)) || (c = aa(l)))
                            : (u = !1);
                      }
          ...
          function On(t, e, i, n) {
            ...
            for (t === e && (e = vr(e)), i && (s = fe(t, je(i))); ++a < o; )
              for (var l = 0, h = e[a], c = i ? i(h) : h; (l = r(s, c, l, n)) > -1; ) s !== t && Yt.call(s, l, 1), Yt.call(t, l, 1);
            return t;
          }
          function zn(t, e) {
          ...
          var Bn = vi
            ...
            Wn = ve
              ? function (t, e) {
                  return ve(t, "toString", { configurable: !0, enumerable: !1, value: Ws(e), writable: !0 });
                }
              : Gs;
          function Un(t) {
            return Ta(As(t));
          ...
          function rr(t, e, i) {
            ...
            for (var a = -1, o = n(r); ++a < r; ) for (var s = t[a], l = -1; ++l < r; ) l != a && (o[a] = Qi(o[a] || s, t[l], e, i));
          ...
          function xr(t, e) {
            return function (i, n) {
              ...
              for (var r = i.length, a = e ? r : -1, o = pt(i); (e ? a-- : ++a < r) && !1 !== n(o[a], a, o); );
              return i;
            };
          }
          function kr(t) {
          ...
          function Fr(t, e, i, r, s, l, h, c) {
            ...
            if (
              ...
              (r = m[3]),
              (s = m[4]),
              !(c = m[9] = void 0 === m[9] ? (u ? 0 : t.length) : oi(m[9] - d, 0)) && 24 & e && (e &= -25),
              e && 1 != e)
            )
              g =
                8 == e || 16 == e
                  ...
                  : (function (t, e, i, r) {
                      ...
                      return function e() {
                        for (
                          var s = -1, l = arguments.length, h = -1, c = r.length, u = n(c + l), d = this && this !== Gt && this instanceof e ? o : t;
                          ++h < c;
          ...
          function Kr(t, e) {
            var i,
              n,
              r = t.__data__;
            return ("string" == (n = typeof (i = e)) || "number" == n || "symbol" == n || "boolean" == n ? "__proto__" !== i : null === i)
          ...
          var no = Ur(function (t) {
            ...
            return !(e > 1 || this.__actions__.length) && n instanceof Ci && sa(i)
              ? ((n = n.slice(i, +i + (e ? 1 : 0))).__actions__.push({ func: io, args: [r], thisArg: void 0 }),
          ...
          function bo(t, e, i) {
            ...
            return (
              (e = os(e) || 0),
              Wo(i) && ((u = !!i.leading), (o = (d = "maxWait" in i) ? oi(os(i.maxWait) || 0, e) : o), (f = "trailing" in i ? !!i.trailing : f)),
              (y.cancel = function () {
          ...
          return (
            ...
            (Si.fill = function (t, e, i, n) {
              var r = null == t ? 0 : t.length;
              return r
                ? (i && "number" != typeof i && la(t, e, i) && ((i = 0), (n = r)),
                  (function (t, e, i, n) {
                    var r = t.length;
                    for (
                      (i = rs(i)) < 0 && (i = -i > r ? 0 : r + i), (n = void 0 === n || n > r ? r : rs(n)) < 0 && (n += r), n = i > n ? 0 : as(n);
                      i < n;
            ...
            (Si.slice = function (t, e, i) {
              var n = null == t ? 0 : t.length;
              return n
                ? (i && "number" != typeof i && la(t, e, i) ? ((e = 0), (i = n)) : ((e = null == e ? 0 : rs(e)), (i = void 0 === i ? n : rs(i))),
                  Zn(t, e, i))
                : [];
            }),
            (Si.sortBy = _o),
            ...
            (Si.split = function (t, e, i) {
              return (
                ...
                (i = void 0 === i ? 4294967295 : i >>> 0)
                  ? (t = ls(t)) && ("string" == typeof e || (null != e && !Vo(e))) && !(e = Kn(e)) && Fe(t)
                    ? cr(Ge(t), 0, i)
                    : t.split(e, i)
                  : []
              );
            ...
            (Si.throttle = function (t, e, i) {
              ...
              if ("function" != typeof t) throw new gt(a);
              return (
                Wo(i) && ((n = "leading" in i ? !!i.leading : n), (r = "trailing" in i ? !!i.trailing : r)),
            ...
            (Si.lastIndexOf = function (t, e, i) {
              ...
              var r = n;
              return (
                void 0 !== i && (r = (r = rs(i)) < 0 ? oi(n + r, 0) : si(r, n - 1)),
                e == e
                  ? (function (t, e, i) {
            ...
            (Si.template = function (t, e, i) {
              ...
              var r,
                ...
                f =
                  "//# sourceURL=" +
                  (kt.call(e, "sourceURL") ? (e.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++qt + "]") +
                  "\n";
              ...
              (Ci.prototype[t] = function (i) {
                ...
                return (
                  n.__filtered__
                    ...
                    : n.__views__.push({ size: si(i, 4294967295), type: t + (n.__dir__ < 0 ? "Right" : "") }),
                  n
                );
              }),
            ...
            se(["filter", "map", "takeWhile"], function (t, e) {
              ...
              Ci.prototype[t] = function (t) {
                var e = this.clone();
                return e.__iteratees__.push({ iteratee: Xr(t, 3), type: i }), (e.__filtered__ = e.__filtered__ || n), e;
              };
            }),
            ...
            (Ci.prototype.slice = function (t, e) {
              ...
              return i.__filtered__ && (t > 0 || e < 0)
                ? new Ci(i)
                : (t < 0 ? (i = i.takeRight(-t)) : t && (i = i.drop(t)), void 0 !== e && (i = (e = rs(e)) < 0 ? i.dropRight(-e) : i.take(e - t)), i);
            }),
              ...
              r &&
                (Si.prototype[e] = function () {
                  ...
                  if (!a && h) {
                    e = p ? e : new Ci(this);
                    var _ = t.apply(e, o);
                    return _.__actions__.push({ func: io, args: [c], thisArg: void 0 }), new ji(_, u);
                  }
            ...
            hn(Ci.prototype, function (t, e) {
              ...
              if (i) {
                var n = i.name + "";
                kt.call(yi, n) || (yi[n] = []), yi[n].push({ name: e, func: i });
              }
            }),
            ...
            (Si.prototype.reverse = function () {
              ...
              if (t instanceof Ci) {
                ...
                return (
                  ...
                  (e = e.reverse()).__actions__.push({ func: io, args: [Ba], thisArg: void 0 }),
  ...
  function (t, e, i) {
    ...
    const b =
      window && !window.L_NO_TOUCH && !o && (d || "ontouchstart" in window || (window.DocumentTouch && document instanceof window.DocumentTouch));
    function x(t) {
    ...
    E(["transition", "webkitTransition", "OTransition", "MozTransition", "msTransition"]),
      E(["transformProperty", "WebkitTransform", "OTransform", "MozTransform", "msTransform"]);
    function L(t, e) {
      (function (t, e) {
    ...
    let K =
      ((tt = (Q = "123456789abcdefghijkmnopqrstuvwxyzABCDEFGHJKLMNPQRSTUVWXYZ").length),
      {
        encode: function (t) {
    ...
    lt.extend = function (t) {
      ...
      return (
        ...
        t.includes && (N.apply(null, [n].concat(t.includes)), delete t.includes),
    ...
    class ht {
      ...
      fire(t, e) {
        if (!this.hasEventListeners(t)) return this;
        for (var i = C({ type: t, target: this }, e), n = this._tl_events[t].slice(), r = 0, a = n.length; r < a; r++)
          n[r].action ? n[r].action.call(n[r].context || this, i) : O(`no action defined for ${t} listener`);
        return this;
      }
    }
    function ct(t, e) {
    ...
    const ut = (function () {
      ...
      function T(t) {
        ...
        return (r ? ((e = r[1]), (i = r[2]), (n = r[3]), "#" + ((1 << 24) | (e << 16) | (i << 8) | n).toString(16).slice(1)) : t).replace(
          /#(\w)(\w)(\w)$/,
          "#$1$1$2$2$3$3"
        );
      }
          ...
          ? (function (t, e, i) {
              ...
              for (n = 0; n < 6; n++)
                (a = Math.min(15, parseInt(e.charAt(n), 16))),
                  ...
                  (r = (r = Math.floor((o - a) * t + a)) > 15 ? 15 : r < 0 ? 0 : r),
                  (s[n] = r.toString(16));
              return "#" + s.join("");
            })(t, i[a][r], n[a][r])
          : ((o = Math.round(1e3 * ((n[a][r] - i[a][r]) * t + i[a][r])) / 1e3), r in p || (o += e[a][r] || "px"), o);
      }
        ...
        for (u && ((n = e.left), (r = e.top), delete e.right, delete e.bottom, delete e.left, delete e.top), i = a.length; i--; ) {
          ...
          for (var L in e) {
            ...
            "string" != typeof I || !s.test(I) || s.test(N)
              ? ((d[i][L] = "transform" == L ? x(N) : "string" == typeof I && s.test(I) ? T(N).slice(1) : parseFloat(N)),
                (f[i][L] = "transform" == L ? x(I, d[i][L]) : "string" == typeof I && "#" == I.charAt(0) ? T(I).slice(1) : j(I, parseFloat(N))),
    ...
    class ft {
      ...
      disable() {
        _t.removeListener(this._el.drag, this.dragevent.down, this._onDragStart, this),
          _t.removeListener(this._el.drag, this.dragevent.up, this._onDragEnd, this);
      }
      stopMomentum() {
      ...
      _onDragStart(t) {
        b
          ...
          _t.addListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
          _t.addListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this);
      }
      _onDragEnd(t) {
        (this.data.sliding = !1),
          _t.removeListener(this._el.drag, this.dragevent.move, this._onDragMove, this),
          _t.removeListener(this._el.drag, this.dragevent.leave, this._onDragEnd, this),
    ...
    var pt,
      ...
      mt = (function () {
        var t,
          ...
          w = { tr: l.createElement("tbody"), tbody: v, thead: v, tfoot: v, td: y, th: y, "*": l.createElement("div") },
        ...
        function F(e, i, n) {
          for (t in i)
            n && (I(i[t]) || S(i[t]))
              ? (I(i[t]) && !I(e[t]) && (e[t] = {}), S(i[t]) && !S(e[t]) && (e[t] = []), F(e[t], i[t], n))
              : void 0 !== i[t] && (e[t] = i[t]);
        }
        function H(t, i) {
        ...
        function U(t) {
          ...
          try {
            return t
              ? "true" == t ||
                  ("false" != t && ("null" == t ? null : /^0/.test(t) || isNaN((i = Number(t))) ? (/^[\[\{]/.test(t) ? e.parseJSON(t) : t) : i))
              : t;
          } catch (e) {
            return t;
          }
        ...
        return (
          ...
          (M.qsa = function (t, e) {
            ...
            return C(t) && s && n
              ...
              ? []
              : o.call(s && !n ? (r ? t.getElementsByClassName(a) : t.getElementsByTagName(e)) : t.querySelectorAll(e));
          }),
          ...
          (e.map = function (t, i) {
            var n,
              ...
              o,
              s = [];
            if (O(t)) for (r = 0; r < t.length; r++) null != (n = i(t[r], r)) && s.push(n);
            ...
            (e.fn[t] = function () {
              ...
              return a.length < 1
                ...
                : this.each(function (t, s) {
                    (r = n ? s : s.parentNode),
                      (s = 0 == i ? s.nextSibling : 1 == i ? s.firstChild : 2 == i ? s : null),
          ...
          return (
            (!i && e.isDefaultPrevented) ||
              ...
              (void 0 !== i.defaultPrevented
                ...
                : "returnValue" in i
                ? !1 === i.returnValue
                : i.getPreventDefault && i.getPreventDefault()) && (e.isDefaultPrevented = g)),
            e
          );
        }
        function x(t) {
                  ...
                  l &&
                    ...
                    a &&
                      (c = function (e) {
                        ...
                        if (o && o !== r)
                          return (n = t.extend(x(e), { currentTarget: o, liveFired: r })), (h || s).apply(o, [n].concat(i.call(arguments, 1)));
                      }),
                    _(r, e, s, o, a, c || h);
                }));
          }),
        ...
        (t.active = 0),
          (t.ajaxJSONP = function (e, i) {
            ...
            return (
              ...
              t(h).on("load error", function (n, r) {
                clearTimeout(o),
                  t(h).off().remove(),
                  "error" != n.type && a ? u(a[0], _, e, i) : d(null, r || "error", _, e, i),
                  (window[l] = f),
          ...
          (t.ajax = function (n) {
            ...
            !(function (e) {
              ...
              (function (e) {
                e.processData && e.data && "string" != t.type(e.data) && (e.data = t.param(e.data, e.traditional)),
                  !e.data || (e.type && "GET" != e.type.toUpperCase()) || ((e.url = _(e.url, e.data)), (e.data = void 0));
              })(r),
            ...
            if (
              ...
              (r.contentType || (!1 !== r.contentType && r.data && "GET" != r.type.toUpperCase())) &&
                w("Content-Type", r.contentType || "application/x-www-form-urlencoded"),
              r.headers)
            )
                  ...
                  if ((x.status >= 200 && x.status < 300) || 304 == x.status || (0 == x.status && "file:" == b)) {
                    (f =
                      ...
                      (function (t) {
                        return (
                          t && (t = t.split(";", 2)[0]),
                          (t && ("text/html" == t ? "html" : "application/json" == t ? "json" : o.test(t) ? "script" : s.test(t) && "xml")) || "text"
                        );
            ...
            return new Promise(function (i, n) {
              (e.onreadystatechange = function () {
                try {
                  ...
                  n({ status: 400, statusText: `Error fetching JSON from ${t}: ${e}` });
                }
              }),
                e.open("GET", t, !0),
                e.send();
          ...
          return (
            ...
            (function e(i, n, r, a) {
              ...
              t.each(n, function (n, h) {
                (o = t.type(h)),
                  a && (n = r ? a : a + "[" + (l || "object" == o || "array" == o ? n : "") + "]"),
                  !a && s ? i.add(h.name, h.value) : "array" == o || (!r && "object" == o) ? e(i, h, r, n) : i.add(n, h);
              });
            })(n, e, i),
            n.join("&").replace(/%20/g, "+")
          );
    ...
    const Tt = {
      ...
      Mt = lt.extend({
        ...
        floor: function (t) {
          for (var e = new Date(this.data.date_obj.getTime()), i = 0; i < wt.length; i++) if ((wt[i][2](e), wt[i][0] == t)) return new Mt(e);
        ...
        findBestFormat: function (t) {
          for (var e = bt, i = 0; i < e.length; i++) if (this.data[e[i]]) return t ? t in Tt || (t = "short") : (t = "base"), Tt[t][e[i]];
          return "";
        },
    ...
    const Dt = [
      ...
      At = Mt.extend({
        initialize: function (t, e, i) {
          Lt == t.constructor ? (this.data = { date_obj: t }) : ((this.data = JSON.parse(JSON.stringify(t))), this._createDateObj()),
            this._setFormat(e, i);
        },
        _createDateObj: function () {
          var t = this._getDateData();
    ...
    (jt.fallback = { messages: {} }), (jt.DATE_FORMAT_TOKENS = /d{1,4}|m{1,4}|yy(?:yy)?|([HhMsTt])\1?|[LloSZ]|"[^"]*"|'[^']*'/g);
    var It = {
      en: {
    ...
    class Rt {
      ...
      _initLayout() {
        (this._el.message_container = T("div", "tl-message-container", this._el.container)),
          (this._el.loading_icon = T("div", this.options.message_icon_class, this._el.message_container)),
          (this._el.message = T("div", "tl-message-content", this._el.message_container)),
          this.updateMessage();
      }
      _initEvents() {
    ...
    function Yt(t) {
      return Wt.a.sanitize(t, { ADD_TAGS: ["iframe"], ADD_ATTR: ["frameborder", "target"] });
    }
    ...
    class Vt {
      ...
      validate() {
        ...
        for (var t = 0; t < this.eras.length; t++) {
          var e;
          if (void 0 === this.eras[t].start_date || void 0 === this.eras[t].end_date)
      ...
      addEvent(t, e) {
        ...
        return void 0 === t.start_date
          ...
          : (this._processDates(t), this._tidyFields(t), this.events.push(t), (this.event_dict[i] = t), e || Pt(this.events), i);
      }
      addEra(t) {
      ...
      _makeUniqueIdentifiers(t, e) {
        for (var i = [t], n = 0; n < e.length; n++)
          F(e[n].unique_id) &&
            ((e[n].unique_id = $(e[n].unique_id)), -1 == i.indexOf(e[n].unique_id) ? i.push(e[n].unique_id) : (e[n].unique_id = ""));
          ...
          !1 !== o || (a !== i.delimiter && a !== i.lineterminator)
            ? a !== i.quotechar
              ...
              ? t.charAt(n + 1) === i.quotechar
                ...
                : (o = !1)
              : ((o = !0), (s = !0))
            : ((l = r(l)), h.push(l), a === i.lineterminator && (c.push(h), (h = [])), (l = ""), (s = !1));
      ...
      await Jt({ url: `${e}${t}` })
        ...
        .catch((t) => {
          if ("response_not_csv" == t.proxy_err_code)
            throw new D("Timeline could not read the data for your timeline. Make sure you have published it to the web.");
              ...
              !(function (t, e) {
                ...
                (function (t) {
                  ...
                  if (Object.keys(e).includes("Start Date") || Object.keys(e).includes("End Date"))
                    e["Start Date"] && (n.start_date = Et(e["Start Date"])), e["End Date"] && (n.end_date = Et(e["End Date"]));
                  else {
                    if (
    ...
    async function ie(t, e) {
      let i = null,
        n = {};
      if (
        ("function" == typeof e ? (i = e) : "object" == typeof e && ((n = e), (i = e.callback), "function" == typeof n.callback && (i = n.callback)),
        !i)
      )
        throw new D(
      ...
      if (te(t)) {
        ...
        if (((r = new Vt(a)), a.errors)) for (var o = 0; o < a.errors.length; o++) r.logError(a.errors[o]);
        i(r);
      } else
        vt({
          url: t,
    ...
    var re = {},
      ae = function (t, e) {
        ...
        for (var i = 0; i < e.length - 1; i++) {
          var n = e[i],
            r = e[i + 1];
          re[t].push(new ne({ scale: n[3], minor: { name: n[0], factor: n[1] }, major: { name: r[0], factor: r[1] } }));
        }
      };
    ...
    class se {
      constructor(t, e) {
        var i = t.events;
        (this._scale = t.scale),
          (e = C({ display_width: 500, screen_multiplier: 3, max_rows: null }, e)),
    ...
    class he {
      constructor(t, e, i, n) {
        (this.start_date = t),
          ...
          (this.options = { duration: 1e3, ease: at, width: 600, height: 600, marker_width_min: 100 }),
          (this.active = !1),
          (this.animator = {}),
          (this.has_end_date = !1),
          C(this.options, n),
      ...
      setRowPosition(t, e) {
        this.setPosition({ top: t }), e < 56 && S(this._el.content_container, "tl-timeera-content-container-small");
      }
      setColor(t) {
      ...
      _initLayout() {
        (this._el.container = T("div", "tl-timeera")),
          ...
          (this._el.content_container = T("div", "tl-timeera-content-container", this._el.container)),
          (this._el.background = T("div", "tl-timeera-background", this._el.content_container)),
          (this._el.content = T("div", "tl-timeera-content", this._el.content_container)),
          (this._el.text = T("div", "tl-timeera-text", this._el.content)),
          (this._text = T("h2", "tl-headline", this._el.text)),
          this.headline && "" != this.headline && (this._text.innerHTML = Z(this.headline)),
          this.onLoaded();
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
      ...
      _createTickElements(t, e, i, n) {
        ...
        for (a = 0; a < t.length; a++) {
          ...
          if (!(s.getTime() in r)) {
            ...
            (h.innerHTML = t), o.push({ tick: l, tick_text: h, display_date: t, date: s });
          }
        }
        return o;
      }
        ...
        if (t[1] && t[0]) {
          ...
          for (var r = 1, a = 0; a < t.length; a++) {
            ...
            (o.tick.style.left = e.getPosition(o.date.getMillisecond()) + "px"),
              ...
              n > 1
                ? r >= n
                  ? ((r = 1), (o.tick_text.style.opacity = 1), (o.tick.className = "tl-timeaxis-tick"))
                  : (r++, (o.tick_text.style.opacity = 0), (o.tick.className = "tl-timeaxis-tick tl-timeaxis-tick-hidden"))
                : ((o.tick_text.style.opacity = 1), (o.tick.className = "tl-timeaxis-tick"));
          }
        }
      }
      _initLayout() {
        (this._el.content_container = T("div", "tl-timeaxis-content-container", this._el.container)),
          (this._el.major = T("div", "tl-timeaxis-major", this._el.content_container)),
          (this._el.minor = T("div", "tl-timeaxis-minor", this._el.content_container)),
          this.onLoaded();
      }
      _initEvents() {}
      _updateDisplay(t, e, i) {
    ...
    class ue {
      ...
      _initLayout() {
        if (
          ((this._el.content_container = T("div", "tl-text-content-container", this._el.container)),
          (this._el.date = T("h3", "tl-headline-date", this._el.content_container)),
          "" != this.data.headline)
        ) {
          var t = "tl-headline";
        ...
        if ("" != this.data.text) {
          var e = "";
          (e += (i = 1 == this.options.autolink ? Y(this.data.text) : this.data.text).match(/<p>[\s\S]*?<\/p>/) ? i : "<p>" + i + "</p>"),
            (this._el.content = T("div", "tl-text-content", this._el.content_container)),
    ...
    class de {
      constructor(t, e, i) {
        i && this.setLanguage(i),
          ...
          this.options.background ||
            ((this._el.container = T("div", "tl-media")), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout());
      }
      loadMedia() {
        var t = this;
      ...
      loadErrorDisplay(t) {
        ...
        (this._el.content_item = T("div", "tl-media-item tl-media-loaderror", this._el.content)),
      ...
      showMeta(t, e) {
        (this._state.show_meta = !0),
          this.data.credit &&
            "" != this.data.credit &&
            ((this._el.credit = T("div", "tl-credit", this._el.content_container)),
            (this._el.credit.innerHTML = 1 == this.options.autolink ? Y(this.data.credit) : this.data.credit),
            (this.options.credit_height = this._el.credit.offsetHeight)),
          this.data.caption &&
            "" != this.data.caption &&
            ((this._el.caption = T("div", "tl-caption", this._el.content_container)),
            (this._el.caption.innerHTML = 1 == this.options.autolink ? Y(this.data.caption) : this.data.caption),
      ...
      _initLayout() {
        (this.message = new Rt(this._el.container, this.options, this.getLanguage())),
          (this._el.content_container = T("div", "tl-media-content-container", this._el.container)),
          this.data.link && "" != this.data.link
            ? ((this._el.link = T("a", "tl-media-link", this._el.content_container)),
            ...
            : (this._el.content = T("div", "tl-media-content", this._el.content_container));
      }
      _updateDisplay(t, e, i) {
    ...
    class fe extends de {
      ...
      createMedia() {
        ...
        (this.data.url.match(/.png(\?.*)?$/) || this.data.url.match(/.svg(\?.*)?$/)) && (e = "tl-media-item tl-media-image"),
          ...
          this.data.alt ? (this._el.content_item.alt = this.data.alt) : this.data.caption && (this._el.content_item.alt = G(this.data.caption)),
          this.data.title
            ? (this._el.content_item.title = this.data.title)
            : this.data.caption && (this._el.content_item.title = G(this.data.caption)),
    ...
    let me = new (class {
      ...
      finish(t) {
        ...
        n &&
          ...
          (i = n.urls).shift(),
          (this.pollCount = 0),
          i.length || (e && e.call(n.context, n.obj), (this.pending[t] = null), this.queue[t].length && this.load(t)));
      }
      getEnv() {
      ...
      load(t, e, i, n, r) {
        var a,
          ...
          f = [];
        if (e)
          if (((e = "string" == typeof e ? [e] : e.concat()), d || this.env.async || this.env.gecko || this.env.opera))
            this.queue[t].push({ urls: e, callback: i, obj: n, context: r });
          else for (a = 0, o = e.length; a < o; ++a) this.queue[t].push({ urls: [e[a]], callback: a === o - 1 ? i : null, obj: n, context: r });
        if (!this.pending[t] && (l = this.pending[t] = this.queue[t].shift())) {
          for (a = 0, o = (h = l.urls).length; a < o; ++a)
            (c = h[a]),
              d
                ? (s = this.env.gecko ? this.createNode("style") : this.createNode("link", { href: c, rel: "stylesheet" }))
    ...
    class ge extends de {
      _loadMedia() {
        ...
        (this.youtube_loaded = !1),
          ...
          this.data.url.match("start=")
            ...
            : this.data.url.match("t=") && (this.media_id.start = et(this.data.url.split("t=")[1])),
          this.data.url.match("end=") && (this.media_id.end = et(this.data.url.split("end=")[1])),
      ...
      _updateMediaDisplay() {
        (this._el.content_item.style.height = X({ w: this.options.width }) + "px"), (this._el.content_item.style.width = this.options.width + "px");
      }
      _stopMedia() {
    ...
    class xe extends de {
      ...
      _updateMediaDisplay() {
        this._el.content_item.style.height = X({ w: this._el.content_item.offsetWidth }) + "px";
      }
      _stopMedia() {
        try {
    ...
    class ke extends de {
      ...
      _updateMediaDisplay() {
        this._state.loaded && (this._el.content_item.style.height = X({ w: this._el.content_item.offsetWidth }) + "px");
      }
      _stopMedia() {
    ...
    class Te extends de {
      ...
      _updateMediaDisplay() {
        var t = J({ w: this._el.content_item.offsetWidth, h: this.options.height });
        this._el.content_item.style.height = t.h + "px";
      }
      _stopMedia() {
    ...
    class Me extends de {
      ...
      createMedia(t) {
        ...
        (a = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
          ...
          (a = a.replace(/<a href/gi, '<a target="_blank" rel="noopener" href')).includes("pic.twitter.com")
            ? (pe("https://platform.twitter.com/widgets.js", function () {
                twttr.widgets.createTweet(s.media_id, s._el.content_item, { conversation: "none", linkColor: "#cc0000", theme: "light" });
              }),
              this.onLoaded())
            : ((r += a),
              (r += "<div class='vcard'>"),
              (r += "<a href='" + i + "' class='twitter-date' rel='noopener' target='_blank'>" + n + "</a>"),
              (r += "<img src='' class='tl-media-item tl-media-image'></a>"),
              (r += "<div class='author'>"),
              (r += "<a class='screen-name url' href='" + t.author_url + "' rel='noopener' target='_blank'>"),
    ...
    class Ee extends de {
      ...
      createMedia(t) {
        ...
        (a = t.html.split("</p>&mdash;")[0] + "</p></blockquote>"),
          ...
          (i = (o = t.html.split("</p>&mdash;")[1].split('<a href="')[1]).split('">')[0]),
          (n = o.split('">')[1].split("</a>")[0]),
          (a = a.replace(/<a href/gi, '<a target="_blank" rel="noopener" href'));
        let s = this.media_id;
      ...
      _loadMedia() {
        ...
        (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content)),
          ...
          this.data.url.match(/\.html$/)
            ...
            : this.data.url.match(/.(json|js)$/) || O("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
          pe(["https://assets.documentcloud.org/viewer/loader.js", "https://assets.documentcloud.org/viewer/viewer.js"], function () {
            t.createMedia();
          });
      }
      _transformURL(t) {
    ...
    function Ae(t) {
      (this.oembed_response = t),
        ...
        this.data.alt ? (this._el.content_item.alt = this.data.alt) : this.data.caption && (this._el.content_item.alt = G(this.data.caption)),
        this.data.title ? (this._el.content_item.title = this.data.title) : this.data.caption && (this._el.content_item.title = G(this.data.caption)),
    ...
    class Ce extends de {
      ...
      createMedia() {
        ...
        try {
          vt({ url: t, dataType: "json", success: Ae, error: je, context: this });
        } catch (e) {
      ...
      _updateMediaDisplay(t) {
        ...
        (e = c ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30),
          ...
          e > this.options.width
            ? (O("height is greater"), (i = this.options.width + 80 + "px"), (n = this.options.width + "px"))
            : (O("width is greater"), O(this.options.width), (i = e + "px"), (n = e - 80 + "px")),
    ...
    class Re extends de {
      ...
      _updateMediaDisplay() {
        (this._el.content_item.style.width = this.options.width + "px"), (this._el.content_item.style.height = X({ w: this.options.width }) + "px");
      }
    }
    class Pe extends de {
      _loadMedia() {
    ...
    function $e(t, e) {
      var i = [
        { type: "youtube", name: "YouTube", match_str: "^(https?:)?/*(www.)?youtube|youtu.be", cls: ge },
        { type: "vimeo", name: "Vimeo", match_str: "^(https?:)?/*(player.)?vimeo.com", cls: xe },
        { type: "dailymotion", name: "DailyMotion", match_str: "^(https?:)?/*(www.)?dailymotion.com", cls: ke },
        { type: "vine", name: "Vine", match_str: "^(https?:)?/*(www.)?vine.co", cls: Te },
        { type: "soundcloud", name: "SoundCloud", match_str: "^(https?:)?/*(player.)?soundcloud.com", cls: be },
        { type: "twitter", name: "Twitter", match_str: "^(https?:)?/*(www.)?twitter.com", cls: Me },
        { type: "twitterembed", name: "TwitterEmbed", match_str: "<blockquote class=['\"]twitter-tweet['\"]", cls: Ee },
        {
          type: "googlemaps",
          name: "Google Map",
          match_str:
        ...
        { type: "flickr", name: "Flickr", match_str: "^(https?:)?/*(www.)?flickr.com/photos", cls: Le },
        { type: "flickr", name: "Flickr", match_str: "^(https?://)?flic.kr/.*", cls: Le },
        { type: "instagram", name: "Instagram", match_str: /^(https?:)?\/*(www.)?(instagr.am|^(https?:)?\/*(www.)?instagram.com)\/p\//, cls: Ce },
        {
          type: "profile",
          name: "Profile",
        ...
        { type: "documentcloud", name: "Document Cloud", match_str: /documentcloud.org\//, cls: Se },
        { type: "image", name: "Image", match_str: /(jpg|jpeg|png|gif|svg|webp)(\?.*)?$/i, cls: fe },
        { type: "imgur", name: "Imgur", match_str: /^.*imgur.com\/.+$|<blockquote class=['\"]imgur-embed-pub['\"]/i, cls: Re },
        {
          type: "googledocs",
          name: "Google Doc",
          match_str:
        ...
        { type: "pdf", name: "PDF", match_str: /^.*\.pdf(\?.*)?(\#.*)?/, cls: Pe },
        { type: "wikipedia", name: "Wikipedia", match_str: "^(https?:)?/*(www.)?wikipedia.org|^(https?:)?/*([a-z][a-z].)?wikipedia.org", cls: we },
        ...
        { type: "video", name: "Video", match_str: /(mp4|webm)(\?.*)?$/i, cls: Fe },
        { type: "wistia", name: "Wistia", match_str: /https?:\/\/(.+)?(wistia\.com|wi\.st)\/.*/i, cls: He },
        { type: "audio", name: "Audio", match_str: /(mp3|wav|m4a)(\?.*)?$/i, cls: qe },
    ...
    class Be {
      ...
      setHeight(t) {
        ...
        (this._el.content_container.style.height = t + "px"),
          ...
          t <= 56
            ? L(this._el.content_container, "tl-timemarker-content-container-small")
            : S(this._el.content_container, "tl-timemarker-content-container-small"),
          l
            ? ((e = Math.floor(t / 14)) < 1 && (e = 1), (this._text.className = "tl-headline"), (this._text.style.webkitLineClamp = e))
            : ((e = t / 12),
              (this._text.className = e > 1 ? "tl-headline tl-headline-fadeout" : "tl-headline"),
      ...
      _initLayout() {
        ...
        (this._el.text = T("div", "tl-timemarker-text", this._el.content)),
          ...
          this.data.text.headline && "" != this.data.text.headline
            ...
            : this.data.media && this.data.media.caption && "" != this.data.media.caption && (this._text.innerHTML = Z(this.data.media.caption)),
          this.onLoaded();
      }
      _initEvents() {
    ...
    class We {
      ...
      enable(t) {
        _t.addListener(this._el.drag, this.dragevent.down, this._onDragStart, this),
          _t.addListener(this._el.drag, this.dragevent.up, this._onDragEnd, this),
          (this.data.pos.start = 0),
          (this._el.move.style.left = this.data.pos.start.x + "px"),
          (this._el.move.style.top = this.data.pos.start.y + "px"),
          (this._el.move.style.position = "absolute");
    ...
    class Ue {
      ...
      _initLayout() {
        (this._el.attribution = T("div", "tl-attribution", this._el.container)),
          ...
          (this._el.slider_background = T("div", "tl-timenav-slider-background", this._el.slider)),
          (this._el.marker_container_mask = T("div", "tl-timenav-container-mask", this._el.slider)),
          (this._el.marker_container = T("div", "tl-timenav-container", this._el.marker_container_mask)),
          (this._el.marker_item_container = T("div", "tl-timenav-item-container", this._el.marker_container)),
          (this._el.timeaxis = T("div", "tl-timeaxis", this._el.slider)),
          (this._el.timeaxis_background = T("div", "tl-timeaxis-background", this._el.container)),
          (this._el.attribution.innerHTML = ""),
          (this.timeaxis = new ce(this._el.timeaxis, this.options, this.language)),
          (this._swipable = new We(this._el.slider_background, this._el.slider, {
            enable: { x: !0, y: !1 },
      ...
      _initEvents() {
        this._swipable.on("dragmove", this._onDragMove, this),
          _t.addListener(this._el.container, "mousewheel", this._onMouseScroll, this),
          _t.addListener(this._el.container, "DOMMouseScroll", this._onMouseScroll, this);
      }
      _initData() {
    ...
    class Ze {
      constructor(t, e, i, n) {
        n && this.setLanguage(n),
          ...
          (this.options = { duration: 1e3, slide_padding_lr: 40, ease: at, width: 600, height: 600, skinny_size: 650, media_name: "" }),
          (this.active = !1),
          (this.animator = {}),
          C(this.options, e),
          C(this.data, t),
      ...
      setActive(t) {
        (this.active = t),
          this.active ? (this.data.background && this.fire("background_change", this.has.background), this.loadMedia()) : this.stopMedia();
      }
      addTo(t) {
        t.appendChild(this._el.container);
      }
      ...
      _initLayout() {
        if (
          ...
          (this._el.scroll_container = T("div", "tl-slide-scrollable-container", this._el.container)),
          (this._el.content_container = T("div", "tl-slide-content-container", this._el.scroll_container)),
          (this._el.content = T("div", "tl-slide-content", this._el.content_container)),
          (this._el.background = T("div", "tl-slide-background", this._el.container)),
        ...
        this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0),
          ...
          (this.has.text || this.has.headline) &&
            ((this._text = new ue(this.data.text, { title: this.has.title, language: this.options.language, autolink: this.data.autolink })),
            this._text.addDateText(this.getFormattedDate())),
          this.has.text || this.has.headline || !this.has.media
            ? this.has.headline && this.has.media && !this.has.text
              ? (L(this._el.container, "tl-slide-media-only"), this._text.addTo(this._el.content), this._media.addTo(this._el.content))
              : this.has.text && this.has.media
              ? (this._media.addTo(this._el.content), this._text.addTo(this._el.content))
              : (this.has.text || this.has.headline) && (L(this._el.container, "tl-slide-text-only"), this._text.addTo(this._el.content))
            : (L(this._el.container, "tl-slide-media-only"), this._media.addTo(this._el.content)),
          this.onLoaded();
      }
      _initEvents() {}
    ...
    class Ge {
      constructor(t, e, i) {
        (this._el = { container: {}, content_container: {}, icon: {}, title: {}, description: {} }),
          ...
          C(this.options, e),
          C(this.data, t),
          (this._el.container = T("div", "tl-slidenav-" + this.options.direction)),
      ...
      _initLayout() {
        (this._el.content_container = T("div", "tl-slidenav-content-container", this._el.container)),
          (this._el.icon = T("div", "tl-slidenav-icon", this._el.content_container)),
          (this._el.title = T("div", "tl-slidenav-title", this._el.content_container)),
          (this._el.description = T("div", "tl-slidenav-description", this._el.content_container)),
    ...
    class Ye {
      constructor(t, e, i, n) {
        n && this.setLanguage(n),
          ...
          "object" == typeof t ? ((this._el.container = t), (this.options.id = B(6, "tl"))) : ((this.options.id = t), (this._el.container = x(t))),
      ...
      updateDisplay(t, e, i, n) {
        ...
        for (var o = 0; o < this._slides.length; o++)
          this._slides[o].updateDisplay(this.options.width, this.options.height, a),
      ...
      changeBackground(t) {
        ...
        t.color_value && "" != t.color_value
          ? (e = j(t.color_value)) || (O("Invalid color value " + t.color_value), (e = this.options.default_bg_color))
      ...
      _initLayout() {
        L(this._el.container, "tl-storyslider"),
          (this._el.slider_container_mask = T("div", "tl-slider-container-mask", this._el.container)),
          (this._el.background = T("div", "tl-slider-background tl-animate", this._el.container)),
          (this._el.slider_container = T("div", "tl-slider-container tlanimate", this._el.slider_container_mask)),
          (this._el.slider_item_container = T("div", "tl-slider-item-container", this._el.slider_container)),
          (this.options.width = this._el.container.offsetWidth),
          (this.options.height = this._el.container.offsetHeight),
          (this._nav.previous = new Ge({ title: "Previous", description: "description" }, { direction: "previous" })),
          (this._nav.next = new Ge({ title: "Next", description: "description" }, { direction: "next" })),
          this._nav.next.addTo(this._el.container),
          this._nav.previous.addTo(this._el.container),
          (this._el.slider_container.style.left = "0px"),
          b &&
            ((this._swipable = new We(this._el.slider_container_mask, this._el.slider_container, { enable: { x: !0, y: !1 }, snap: !0 })),
            this._swipable.enable(),
        ...
        if (this._loaded) {
          ...
          (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e),
            this.hasEventListeners(e) &&
              ("contextmenu" === e && _t.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" }));
        }
      }
      _onLoaded() {
        this.fire("loaded", this.data);
    ...
    class Ve {
      constructor(t, e, i) {
        (this._el = {
          ...
          (this._el.container = "object" == typeof t ? t : x(t)),
          e && (this._el.parent = e),
          (this.options = { width: 600, height: 600, duration: 1e3, ease: st, menubar_default_y: 0 }),
          (this.animator = {}),
          C(this.options, i),
          this._initLayout(),
          this._initEvents();
      ...
      _initLayout() {
        (this._el.button_zoomin = T("span", "tl-menubar-button", this._el.container)),
          (this._el.button_zoomout = T("span", "tl-menubar-button", this._el.container)),
          (this._el.button_backtostart = T("span", "tl-menubar-button", this._el.container)),
          c && this._el.container.setAttribute("ontouchstart", " "),
      ...
      _initEvents() {
        _t.addListener(this._el.button_backtostart, "click", this._onButtonBackToStart, this),
          _t.addListener(this._el.button_zoomin, "click", this._onButtonZoomIn, this),
          _t.addListener(this._el.button_zoomout, "click", this._onButtonZoomOut, this);
      }
      _updateDisplay(t, e, i) {
        t && (this.options.width = t), e && (this.options.height = e);
      }
    ...
    class Xe {
      constructor(t, e, i) {
        if (
          (i || (i = {}),
          (this.ready = !1),
          (this._el = { container: x(t), storyslider: {}, timenav: {}, menubar: {} }),
        ...
        C(this.options, i),
          ...
          i.soundcite &&
            this.on("ready", () => {
              O("Loading Soundcite resources "),
                _e("https://cdn.knightlab.com/libs/soundcite/latest/css/player.css"),
                pe("https://cdn.knightlab.com/libs/soundcite/latest/js/soundcite.min.js");
            }),
          this._loadStyles(),
          ...
          this.options.is_full_embed && L(this._el.container, "tl-timeline-full-embed"),
      ...
      _loadStyles() {
        ...
        if ((t && _e(t), this.options.theme && (0 == this.options.theme.indexOf("http") || this.options.theme.match(/\.css$/))))
        ...
        this.message.removeFrom(this._el.container),
          ...
          "top" == this.options.timenav_position
            ? ((this._el.timenav = T("div", "tl-timenav", this._el.container)),
              (this._el.storyslider = T("div", "tl-storyslider", this._el.container)))
            : ((this._el.storyslider = T("div", "tl-storyslider", this._el.container)),
              (this._el.timenav = T("div", "tl-timenav", this._el.container))),
          ...
          (this._timenav = new Ue(this._el.timenav, this.config, this.options, this.language)),
          ...
          (this._menubar = new Ve(this._el.menubar, this._el.container, this.options)),
      ...
      _updateDisplay(t, e, i) {
        ...
        i && (r = i),
          ...
          b &&
            (this.options.layout = ((n = "portrait"), window.innerWidth > window.innerHeight && (n = "landscape"), Math.abs(window.orientation), n)),
          c
            ? ((a += " tl-mobile"), (this.options.timenav_height = this._calculateTimeNavHeight(t, this.options.timenav_mobile_height_percentage)))
          ...
          e
            ? ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"),
              ...
              (this.animator_storyslider = ct(this._el.storyslider, { height: this.options.storyslider_height + "px", duration: r / 2, easing: ot })),
              this.animator_menubar && this.animator_menubar.stop(),
              (this.animator_menubar = ct(this._el.menubar, { top: o + "px", duration: r / 2, easing: ot })))
            : ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"),
      ...
      _validateOptions() {
        for (
          ...
          var i = t[e],
            n = this.options[i];
          let r = !0;
          "number" == typeof n ? (r = n == parseInt(n)) : "string" == typeof n && (r = n.match(/^\s*(\-?\d+)?\s*$/)),
            r || this.config.logError({ message_key: "invalid_integer_option", detail: i });
        }
      }
      _getSlideIndex(t) {
        if (this.config) {
